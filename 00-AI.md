...
- Shows how to configure code with local llm's
- Guides through downloading and using different AI models
- Also setting PI agentic agent  
[https://www.youtube.com/watch?v=UngVdAsQEiU](https://www.youtube.com/watch?v=UngVdAsQEiU)

# Local LLM Setup

Created a powershell script (LocalAI.ps1) to launch claude, pointing it at my local llm setup.
